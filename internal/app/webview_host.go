...
func newWebViewHost(
	...
	// CSS --ui-display-scale не инжектируем: WebView2 сам масштабирует
	// контент под devicePixelRatio. Размер окна управляется через
	// dpiCompensationFactor() в ui.go (только максимум).
	return host, nil
}
